...
# Audio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/audio/acdb/MTP_Bluetooth_cal.acdb:system/etc/acdbdata/MTP/MTP_Bluetooth_cal.acdb \WITH_DEXPREOPT := false
...
PRODUCT_PACKAGES += \TARGET_BOOTANIMATION_HALF_RES := true
